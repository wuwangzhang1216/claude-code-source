...
export function ModelPicker(t0) {
  ...
  const focusedSupportsXHigh = (() => {
    const focusedModel = resolveOptionModel(focusedValue);
    return focusedModel ? modelSupportsXHighEffort(focusedModel) : false;
  })();
  let t9;
  if ($[23] !== focusedValue) {
...
function cycleEffortLevel(current: EffortLevel, direction: 'left' | 'right', includeMax: boolean, includeXHigh: boolean = false): EffortLevel {
